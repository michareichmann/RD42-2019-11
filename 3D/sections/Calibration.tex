...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% FRAME 2 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}{ADC Calibration - Test Pulses}
    
    \begin{itemize}
			\item chip was trimmed to \SI{40}{vcal}
    \end{itemize}

    \subfigs
			{\subfig{.5}[r]{tp200}[200 VCAL test pulse]}
			{\subfig{.5}[r]{tp40}[40 VCAL test pulse]}
    \begin{itemize}\itemfill 
        \item in temperature equilibrium the read back of the VCAL works well
        \item large sigma of the distribution allows pulse heights below threshold
        \item sigma gets larger for low pulse height due to bigger uncertainty in the fit
    \end{itemize}
